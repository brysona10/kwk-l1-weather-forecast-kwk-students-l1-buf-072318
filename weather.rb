...
def  city_weather_info(weather)
  ...
  puts"The #{weather|:city|} is #{weather[:city]}.The #{weather|:description|} is #{weather[:description]}.The #{weather|:temperature_farenheit|} is #{weather[:temperature_farenheit]}."
end
